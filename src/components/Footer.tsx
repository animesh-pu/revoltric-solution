      ...
      <div className="max-w-7xl mx-auto px-6">
          ...
          <SectionReveal>
            <div className="lg:col-span-1">
              <Link to="/" className="inline-flex items-center gap-2 mb-6">
                ...
                <span className="text-lg font-bold tracking-[0.15em] text-white">REVOLTRIC</span>
              </Link>
              <p className="text-white/40 text-sm leading-relaxed max-w-xs">
                Complete Hospital & Diagnostic Solutions. One professional partner for all healthcare facility requirements.
              </p>
              <div className="flex gap-4 mt-6">
                {["LinkedIn", "Twitter", "Facebook"].map((social) => (
                  <a
                    ...
                    href="#"
                    aria-label={social}
                    className="w-9 h-9 rounded-lg bg-white/5 flex items-center justify-center text-white/40 hover:text-cyan hover:bg-white/10 transition-all duration-300"
                  >
              ...
              <ul className="space-y-3">
                {NAV_LINKS.map((link) => (
                  <li key={link.href}>
                    <Link
                      to={link.href}
                      className="text-sm text-white/40 hover:text-cyan transition-colors duration-300"
                    >
                      {link.label}
                    </Link>
                  </li>
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li className="text-sm text-white/40">
                  <span className="text-white/60 font-medium block mb-1">Phone</span>
                  {/* Placeholder */}
                  <a href="tel:+910000000000" className="hover:text-cyan transition-colors">+91 00000 00000</a>
                </li>
                <li className="text-sm text-white/40">
                  <span className="text-white/60 font-medium block mb-1">Email</span>
                  <a href="mailto:info@revoltric.com" className="hover:text-cyan transition-colors">info@revoltric.com</a>
                </li>
                <li className="text-sm text-white/40">
                  <span className="text-white/60 font-medium block mb-1">Address</span>
                  <span>REVOLTRIC Office, [Address Placeholder], India</span>
                </li>
              </ul>
            </div>
          </SectionReveal>
        ...
        <div className="py-6 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-white/30">
            © {currentYear} REVOLTRIC. All rights reserved.
          </p>
